    ...
    <div class="box">
      ...
      <div class="flex-j-around a-center content bg-c-w">
        <div
          ...
          :class="{ bigImg: index === 0 }"
        >
          <div class="c-hand">
            <img :src="item.picUrl" width="206" height="206" v-if="index !== 0"/>
            <div v-else class="bigImg" style="height:100%;" :style="{'background-image':'url('+item.picUrl+')','background-size':'611px 429px'}">
