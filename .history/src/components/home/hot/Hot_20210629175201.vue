<template>
  <div class="box m-t20">
    ...
    <div class="flex-j-around a-center content bg-c-w">
      <div v-for="(item, index) in arr" :key="index" class="t-a-center content_dv">
        <div class="c-hand">
        ...
        <div class="a-center t-a-center">
          ...
          <div class="hot_btn f-size12 flex-j-center a-center">
            <div size="small" class="detal c-hand">查看详情</div>
            <div size="small" type="primary" class="car f-c-w c-hand m-l10">加入购物车</div>
          </div>
        </div>
      </div>
      <div></div>
