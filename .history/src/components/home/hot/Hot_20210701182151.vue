  ...
  <div class="pro_box">
    ...
    <div class="flex-j-around a-center content bg-c-w">
      ...
      >
        ...
        <div class="hot_btn f-size12 flex-j-center a-center m-t20" style="display:block">
          <div size="small" class="detal c-hand">查看详情</div>
          <div class="p-relative">
            <div class="small_img bg-c-w flex-j-center a-center" ref="smallImg"><img :src="item.picUrl" width="30" height="30" /></div>
            <div
              size="small"
              type="primary"
...
export default {
  ...
  methods: {
    ...
    addCar(id, e) {
      this.$emit("addCar", id);
      this.$refs.smallImg.classList.add('small_img_ani')
    }
  },
  mounted() {
    this.getData();
...
.content_dv {
  ...
  .small_img_ani {
    animation: smallImg 0.5 forwards;
  }
}
@keyframes smallImg {
    0%{transform: 0% 0%;}
