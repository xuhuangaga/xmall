...
export default {
  ...
  methods: {
    ...
    //减法
    reduce() {
      this.$refs.iptNum.classList.add('switchNum')
      //最小为1
...
.switchNum {
  animation: switchNum 0.3s forwards !important;
  // color: red !important;
}
@keyframes switchNum {
  0%{transform: 0px 0px;color: green !important;}
  50%{transform: 0px -5px;color: yellow !important;}
  100%{transform: 0px -15px; color: red !important;}
}
</style>